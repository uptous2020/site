        ...
        <nav className="flex p-0 mt-0 fixed justify-center w-full z-10 top-0"
            ...
            <div className="flex md:flex-row flex-col justify-between">
                <div className="flex justify-center md:justify-between md:pr-20">
                    ...
                    <div>
                        <a className="inline-block text-white text-3xl no-underline hover:text-gray-200 hover:text-underline py-6 px-1 "
                    ...
                    <ul className="self-center flex flex-row justify-evenly md:justify-between text-sm md:text-base">
                        ...
                        </li> */}
                        {
                            pages.filter((page) => {
                                ...
                                <li key={ID}>
                                    <Link href={`${pageRoute}`}>
                                        <a className=" text-white no-underline mr-10 hover:text-gray-200 hover:text-underline">
                        ...
                        <li className="text-orange-100 no-underline hover:text-gray-200 hover:text-underline">
                            <script
