  ...
  return (
    ...
    >
      <div className="flex flex-col items-center lg:flex-row xl:flex-row justify-center sm:items-center sm:flex-col md:flex-row">
        <p className="justify-center text-center text-white">© 2021 Up To Us</p>
        <p className="justify-center invisible text-center text-white ml-6 lg:visible xl:visible sm:invisible md:visible">
          {" "}
          |{" "}
        </p>
        <li>
