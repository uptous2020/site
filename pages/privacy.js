    ...
    <div>
      ...
      <main>
        <section className="body" style={{ backgroundImage: "url('hero.png')" }}>
          ...
          <h6 className="text-white text-left text-lg mx-20 my-4" >
          If you send a friend a communication from the Services, the information you provide (names, email addresses, etc.) is used on a one-time basis to facilitate the communication and is not used for any other marketing purpose, unless we obtain consent from that person. If you otherwise disclose any personal information relating to other people to us, you represent that you have the authority to do so and permit us to use the information in accordance with this Privacy Policy.
          </h6>
          <h5 className="text-white text-left text-lg mx-20 my-4" >
            Information Third Parties Provide About You 
          </h5>
          <h6 className="text-white text-left text-lg mx-20 my-4" >
          We may receive information about you from third parties. For example, if you make a donation to us through a third-party service provider that we use to collect donations or if you participate in a promotion that we are sponsoring on a third party’s platform, we may receive information about you from that third party. We may also supplement the information we collect with outside records from third parties, publicly accessible websites, or public databases. We may combine the information we receive from third parties with information we collect through the Services. In those cases, we will apply this Privacy Policy to the combined information.
