  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className="grid grid-cols-12 gap-4 sm:p-16 mt-16 mb-8 mx-8 md:mt-4 md:mx-0">
          <div className="col-span-12 bg-black md:p-20 sm:p-8 p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-8 my-4 max-w-5xl">
              ...
              <div className="col-span-2">
                ...
                <h1 className="text-blue-100 text-2xl my-2 md:my-8">Deploy</h1>
                <p className="text-white text-sm">
          ...
          <div className=" col-span-12 my-4">
            <div className=" grid grid-cols-1 md:grid-cols-9 my-4">
              ...
              <div className=" md:col-start-6 md:col-end-10 hover:opacity-75">
                <img className="my-4 md:my-0" src="Bloomberg.png" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-black col-span-12 my-4">
            <div className=" grid grid-cols-1 gap-8 md:grid-cols-12 p-6">
              ...
              <div className="md:col-start-5 md:col-end-11">
                <p className="text-white text-left md:text-base text-sm my-3 ">
                  • Up to Us partnered with popular TikTok creators, the Cheeky
                  Boyos (9.2M followers), to give away a Tesla to one lucky
                  voter that checked their voter registration status via our
                  platform, with their Tiktoks generating 6.4MM+ views.
                </p>
                <p className="text-white text-left md:text-base text-sm my-3 ">
                  • Up to Us also worked with the organization Vote Tripling to
                  encourage young voters to recruit their friends and family to
                  check their voter registration status for additional entries
                  to the giveaway.
                </p>
                <p className="text-white text-left md:text-base text-sm my-3 ">
          ...
          <div className="bg-black col-span-12 my-4">
            <div className=" grid grid-cols-1 gap-8 md:grid-cols-12 p-6 md:p-0">
              ...
              <div className="md:col-start-5 md:col-end-11 md:m-3">
                <p className="text-white text-left md:text-base text-sm my-3 ">
                  • Up to Us worked with partners to create and distribute
                  impactful, non-partisan content to celebrities with large and
                  engaged followings.
                </p>
                <p className="text-white text-left md:text-base text-sm my-3 ">
                  • Influential figures who have shared out content include
                  Leonardo DiCaprio, Kerry Washington, Sacha Barron Cohen, Gigi
                  Hadid, Mark Ruffalo, Orlando Bloom, Sara Silverman, Chelsea
                  Handler, Ashton Kutcher, Rosario Dawson, and Kate Hudson,
                  among others.
                </p>
                <p className="text-white text-left md:text-base text-sm my-3 ">
          ...
          <div className="bg-black col-span-12 my-4">
            <div className=" grid grid-cols-1 gap-8 md:grid-cols-12 md:p-0 p-6">
              <div className=" md:col-start-1 md:col-end-5 ">
                ...
                <img className="md:mt-40 mt-4 md:ml-2" src="postmates 1.png" />
              </div>
              <div className="md:col-start-5 md:col-end-11 md:m-3">
                <p className="text-white text-left md:text-base text-sm my-3 ">
                  • Up to Us partnered with Postmates to incentivize young
                  voters to encourage their friends and family to make a voting
                  plan.
                </p>
                <p className="text-white text-left md:text-base text-sm my-3 ">
          ...
          <div className="bg-black col-span-12 my-4">
            <div className=" grid grid-cols-1 gap-8 md:grid-cols-12 p-6">
              <div className="md:col-start-1 md:col-end-5">
                <h1 className="text-white text-xl">Persuasion + Sponsorship</h1>
              ...
              <div className="md:col-start-5 md:col-end-11">
                <p className="text-white text-left md:text-base text-sm my-3 ">
                  ...
                  that would persuade infrequent and distrustful voters to go to
                  the polls.
                </p>
                <p className="text-white text-left md:text-base text-sm my-3 ">
