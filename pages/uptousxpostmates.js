  ...
  return (
    <div>
      ...
      <main className="body h-auto" style={{ backgroundImage: "url('hero.png')" }}>
          ...
          <h5 className="text-white font-bold text-center text-md md:text-lg mx-4 md:mx-20 my-4" >
            What is Postmates?
          </h5>
          ...
          <h5 className="text-white text-center text-md md:text-lg mx-4 md:mx-20 my-4" >
              What is Unlimited?
            </h5>
          <h6 className="text-white text-center text-md md:text-lg mx-4 md:mx-20 my-4" >
